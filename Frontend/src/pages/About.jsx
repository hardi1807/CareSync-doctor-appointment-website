  ...
  return (
    <div>
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          ...
          <p>
           CareSync is committed to excellence in healthcare technology. We
            ...
            ongoing care, CareSync is here to support you every step of the
            way.
          </p>
      ...
      <div className="flex flex-col md:flex-row mb-20">
        ...
        <div className="border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] h hover:bg-blue-500 hover:text-white transition-all duration-300 text-gray-600 cursor-pointer">
          <b>Personalization:</b>
          <p>
